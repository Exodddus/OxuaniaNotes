...
<div style="text-align: center">
        <img src="images/C1/16.png" width=70%>
    </div>
    ...
    - ISA 的七个维度：
        - **ISA 的类别**
            - **栈架构**(stack architecture)：
                ...
                ![type:video](18.mp4){: style='width: 80%'}

            - **累加器架构**(accumulator architecture)：

                ![type:video](19.mp4){: style='width: 80%'}
            ...
            - **通用目的寄存器架构**(general-purpose register architecture, GRA)：
                ...
                - 具体可分为：
                    - **寄存器-内存架构**：任何指令都能访问内存
                        ...
                        ![type:video](20.mp4){: style='width: 80%'}

                    - **加载-存储架构**：只有加载和存储指令才能访问内存
                        - 举例：ARMv8、RISC-V

                        ![type:video](21.mp4){: style='width: 80%'}
