...
![image-20250228135034315](image-20250228135034315.png)
...
![image-20250228140941294](image-20250228140941294.png)

*非线性体现在激活函数*

激活函数不能采用简单的`(0,1)`分段函数的原因：有不可导点且存在梯度消失问题，反馈机制无法根据当前点的导数值判断当前函数和目标点的接近情况。

![image-20250228141834025](image-20250228141834025.png)
...
![image-20250228142350068](image-20250228142350068.png)
...
![image-20250228143150904](image-20250228143150904.png)
...
- 在相同参数的前提下，深的神经网络比浅的神经网络拟合能力更好。
  ...
  ![image-20250228143913837](image-20250228143913837.png)
...
![image-20250228144447318](image-20250228144447318.png)

输出层取最大值的操作也不可导，我们采用softmax layer，把数字间的差距变大，再归一化：

![image-20250228144649727](image-20250228144649727.png)
...
![image-20250228145456574](image-20250228145456574.png)

动态学习率的有一种方法是模拟小球的运动，动量逐渐减少（动态学习率解决振荡问题）且在平坦的地方走得快陡峭的地方走得慢。

这个方法有一个问题是只能找到局部最优解，甚至停留在saddle point：

![image-20250228150154261](image-20250228150154261.png)
